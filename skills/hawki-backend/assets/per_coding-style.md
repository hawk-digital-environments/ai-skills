...
# Coding Style Guide[¶](https://www.php-fig.org/per/coding-style/#coding-style-guide "Permalink")
...
## Overview[¶](https://www.php-fig.org/per/coding-style/#overview "Permalink")
This specification extends, expands and replaces [PSR-12](https://www.php-fig.org/psr/psr-12/), the extended coding style guide and requires adherence to [PSR-1](https://www.php-fig.org/psr/psr-1/), the basic coding standard.
Like [PSR-12](https://www.php-fig.org/psr/psr-12/), the intent of this specification is to reduce cognitive friction when scanning code from different authors. It does so by enumerating a shared set of rules and expectations about how to format PHP code. This PSR seeks to provide a set that coding style tools can implement, projects can declare adherence to and developers can easily relate to between different projects. When various authors collaborate across multiple projects, it helps to have one set of guidelines to be used among all those projects. Thus, the benefit of this guide is not in the rules themselves but the sharing of those rules.
[PSR-12](https://www.php-fig.org/psr/psr-12/) was accepted in 2019 and since then a number of changes have been made to PHP which have implications for coding style guidelines. Whilst [PSR-12](https://www.php-fig.org/psr/psr-12/) is very comprehensive of PHP functionality that existed at the time of writing, new functionality is very open to interpretation. This PER, therefore, seeks to clarify the content of PSR-12 in a more modern context with new functionality available, make the errata to PSR-12 binding and further update it according to new data and language changes.
### Previous language versions[¶](https://www.php-fig.org/per/coding-style/#previous-language-versions "Permalink")
...
### Example[¶](https://www.php-fig.org/per/coding-style/#example "Permalink")
...
## 2. General[¶](https://www.php-fig.org/per/coding-style/#2-general "Permalink")
### 2.1 Basic Coding Standard[¶](https://www.php-fig.org/per/coding-style/#21-basic-coding-standard "Permalink")
...
### 2.2 Files[¶](https://www.php-fig.org/per/coding-style/#22-files "Permalink")
All PHP files MUST use the Unix LF (linefeed) line ending only.
All PHP files MUST end with a non-blank line, terminated with a single LF.
The closing `?>` tag MUST be omitted from files containing only PHP.
### 2.3 Lines[¶](https://www.php-fig.org/per/coding-style/#23-lines "Permalink")
...
### 2.4 Indenting[¶](https://www.php-fig.org/per/coding-style/#24-indenting "Permalink")
Code MUST use an indent of 4 spaces for each indent level, and MUST NOT use tabs for indenting.
### 2.5 Keywords and Types[¶](https://www.php-fig.org/per/coding-style/#25-keywords-and-types "Permalink")
...
### 2.6 Trailing commas[¶](https://www.php-fig.org/per/coding-style/#26-trailing-commas "Permalink")
...
### 2.7 Naming[¶](https://www.php-fig.org/per/coding-style/#27-naming "Permalink")
...
## 3. Declare Statements, Namespace, and Import Statements[¶](https://www.php-fig.org/per/coding-style/#3-declare-statements-namespace-and-import-statements "Permalink")
...
## 4. Classes, Properties, and Methods[¶](https://www.php-fig.org/per/coding-style/#4-classes-properties-and-methods "Permalink")
...
### 4.1 Extends and Implements[¶](https://www.php-fig.org/per/coding-style/#41-extends-and-implements "Permalink")
...
### 4.2 Using traits[¶](https://www.php-fig.org/per/coding-style/#42-using-traits "Permalink")
...
When the class has nothing after the `use` import statement, the class closing brace MUST be on the next line after the `use` import statement. For example:
...
### 4.3 Properties and Constants[¶](https://www.php-fig.org/per/coding-style/#43-properties-and-constants "Permalink")
...
### 4.4 Methods and Functions[¶](https://www.php-fig.org/per/coding-style/#44-methods-and-functions "Permalink")
...
### 4.5 Method and Function Parameters[¶](https://www.php-fig.org/per/coding-style/#45-method-and-function-parameters "Permalink")
...
### 4.6 Modifier Keywords[¶](https://www.php-fig.org/per/coding-style/#46-modifier-keywords "Permalink")
...
### 4.7 Method and Function Calls[¶](https://www.php-fig.org/per/coding-style/#47-method-and-function-calls "Permalink")
...
The `exit()` and `die()` functions SHOULD always be called with parentheses even if no argument is given to clearly distinguish them from an access to a constant named `exit` or `die`. For example:
...
### 4.8 Function Callable References[¶](https://www.php-fig.org/per/coding-style/#48-function-callable-references "Permalink")
...
### 4.9 Property Hooks[¶](https://www.php-fig.org/per/coding-style/#49-property-hooks "Permalink")
...
The following is _**not allowed**_ due to the hook being too complex:
...
## 4.10 Interface and abstract properties[¶](https://www.php-fig.org/per/coding-style/#410-interface-and-abstract-properties "Permalink")
...
## 5. Control Structures[¶](https://www.php-fig.org/per/coding-style/#5-control-structures "Permalink")
...
### 5.1 `if`, `elseif`, `else`[¶](https://www.php-fig.org/per/coding-style/#51-if-elseif-else "Permalink")
...
### 5.2 `switch`, `case`, `match`[¶](https://www.php-fig.org/per/coding-style/#52-switch-case-match "Permalink")
...
### 5.3 `while`, `do while`[¶](https://www.php-fig.org/per/coding-style/#53-while-do-while "Permalink")
...
### 5.4 `for`[¶](https://www.php-fig.org/per/coding-style/#54-for "Permalink")
...
### 5.5 `foreach`[¶](https://www.php-fig.org/per/coding-style/#55-foreach "Permalink")
...
### 5.6 `try`, `catch`, `finally`[¶](https://www.php-fig.org/per/coding-style/#56-try-catch-finally "Permalink")
...
## 6. Operators[¶](https://www.php-fig.org/per/coding-style/#6-operators "Permalink")
...
### 6.1. Unary operators[¶](https://www.php-fig.org/per/coding-style/#61-unary-operators "Permalink")
...
### 6.2. Binary operators[¶](https://www.php-fig.org/per/coding-style/#62-binary-operators "Permalink")
...
### 6.3. Ternary operators[¶](https://www.php-fig.org/per/coding-style/#63-ternary-operators "Permalink")
...
### 6.4. Operator's placement[¶](https://www.php-fig.org/per/coding-style/#64-operators-placement "Permalink")
...
## 7. Closures[¶](https://www.php-fig.org/per/coding-style/#7-closures "Permalink")
...
### 7.1 Short Closures[¶](https://www.php-fig.org/per/coding-style/#71-short-closures "Permalink")
...
## 8. Anonymous Classes[¶](https://www.php-fig.org/per/coding-style/#8-anonymous-classes "Permalink")
...
## 9. Enumerations[¶](https://www.php-fig.org/per/coding-style/#9-enumerations "Permalink")
...
## 10. Heredoc and Nowdoc[¶](https://www.php-fig.org/per/coding-style/#10-heredoc-and-nowdoc "Permalink")
...
The following is _**not allowed**_ due to the heredoc beginning on a different line than the context it's being declared in:
...
The following is _**not allowed**_ due to the scope indention not matching the scope the heredoc is declared in:
...
## 11. Arrays[¶](https://www.php-fig.org/per/coding-style/#11-arrays "Permalink")
...
## 12. Attributes[¶](https://www.php-fig.org/per/coding-style/#12-attributes "Permalink")
### 12.1 Basics[¶](https://www.php-fig.org/per/coding-style/#121-basics "Permalink")
...
### 12.2 Placement[¶](https://www.php-fig.org/per/coding-style/#122-placement "Permalink")
...
### 12.3 Compound attributes[¶](https://www.php-fig.org/per/coding-style/#123-compound-attributes "Permalink")
...
### 12.4 Example[¶](https://www.php-fig.org/per/coding-style/#124-example "Permalink")
...
## Additional Info:
  ...
  * [PER Coding Style Meta Document](https://www.php-fig.org/per/coding-style/meta)
  * [PER Coding Style - Migration Document to v3.0](https://www.php-fig.org/per/coding-style/meta/migration-3.0)
  * [PER Coding Style 2.0](https://github.com/php-fig/per-coding-style/blob/2.0.0/spec.md)
  * [PER Coding Style - Migration Document to v2.0](https://www.php-fig.org/per/coding-style/meta/migration-2.0)
  * [PER Coding Style 1.0](https://github.com/php-fig/per-coding-style/blob/1.0.0/spec.md)


  * [Follow us on Mastodon](https://phpc.social/@phpfig)
  * [Follow us on Bluesky](https://bsky.app/profile/php-fig.org)
  * [Discuss on Discord](https://discord.gg/php-fig)
  * [Contribute via GitHub](https://github.com/php-fig)
  * [Join our mailing list](https://groups.google.com/forum/?fromgroups#!forum/php-fig)


© 2026 PHP Framework Interop Group. Site design by [Jonathan Reinink](https://twitter.com/reinink). Hosting sponsored by the [![platform.sh logo](https://www.php-fig.org/img/platform-sh-logo.png)](https://platform.sh/?utm_campaign=sponsored_sites&utm_source=php_fig "platform.sh") [PHP PaaS](https://platform.sh/?utm_campaign=sponsored_sites&utm_source=php_fig)
